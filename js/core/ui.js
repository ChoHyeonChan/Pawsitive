...
function updateNavAuth() {
 ...
 const dmIcon = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`;
 navAuth.innerHTML = `
 ${isAdmin ? `<button class="nav-icon-btn" onclick="Router.navigate('/admin')" title="관리자"><span class="nav-admin-badge">관리자</span></button>` : ''}
 <button class="nav-icon-btn" onclick="openDMInbox()" title="DM" style="position:relative;">${dmIcon}<span id="dm-nav-badge" style="display:none;position:absolute;top:-2px;right:-2px;min-width:16px;height:16px;border-radius:8px;background:#ef4444;color:#fff;font-size:0.6rem;font-weight:800;align-items:center;justify-content:center;padding:0 3px;"></span></button>
